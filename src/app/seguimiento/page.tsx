...
import AppReviewTrackingForm from "../../components/portal/AppReviewTrackingForm";
import { Sparkles, Layers, ArrowRight } from "../../lib/icons";
...
export default function SeguimientoPage() {
  return (
    <main className="relative min-h-screen bg-[#040407] text-[#F3F4F6] overflow-x-hidden selection:bg-[#00E5FF]/30 selection:text-white">
        ...
        <div className="max-w-[1440px] mx-auto flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-3 group cursor-pointer">
            ...
            <span className="hidden sm:inline-block text-[9px] font-mono px-2 py-0.5 rounded-full bg-white/10 text-[#00D1FF] border border-[#00D1FF]/30 font-bold uppercase">
              REVISIÓN DE APLICACIÓN &amp; SEGUIMIENTO DE TICKETS
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span>+ Cotizador / Nuevo Proyecto</span>
            </Link>

            <Link
              href="/portal"
              className="px-3.5 py-1.5 rounded-full bg-gradient-to-r from-[#FF3858]/20 to-[#00D1FF]/20 hover:from-[#FF3858]/30 hover:to-[#00D1FF]/30 border border-[#00D1FF]/40 text-xs font-mono text-white transition-all flex items-center gap-1.5"
            >
      ...
      {/* Main Container */}
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 sm:py-16 relative z-10 space-y-8">
        {/* Title Header */}
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-[#FF3858]/20 via-purple-500/20 to-[#00D1FF]/20 border border-[#00D1FF]/40 text-xs font-mono text-[#00D1FF] font-bold uppercase">
            ...
            <span>GESTIÓN DE REQUERIMIENTOS, MEJORAS &amp; BUGS</span>
          </div>

          <h1 className="text-3xl sm:text-5xl font-black text-white uppercase tracking-tight font-mono">
            FORMULARIO DE REVISIÓN &amp; SEGUIMIENTO
          </h1>

          <p className="text-xs sm:text-sm text-gray-400 font-light max-w-2xl mx-auto font-mono">
            Reporta requerimientos, dudas operativas o mejoras de forma estructurada. Convierte anotaciones en especificaciones técnicas claras y consulta el estado de resolución en tiempo real.
          </p>
        </div>

        {/* Tracking & Review Form Component */}
        <Suspense fallback={<div className="p-12 text-center text-xs font-mono text-gray-400">Cargando formulario de seguimiento...</div>}>
          <AppReviewTrackingForm />
        </Suspense>
      </div>
