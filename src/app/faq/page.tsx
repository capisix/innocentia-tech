...
export default function FAQPage() {
  ...
  return (
    <main className="relative min-h-screen bg-[#040407] text-[#F3F4F6] overflow-x-hidden selection:bg-[#00E5FF]/30 selection:text-white">
      ...
      {/* Main Two-Column Layout: Accordion Index + Cyber Terminal Live CLI */}
      <section className="max-w-7xl mx-auto px-6 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
        {/* Left Column: Comprehensive FAQ Accordion */}
                  ...
                  <div className="px-5 pb-5 pt-1 text-xs sm:text-sm text-gray-300 font-light leading-relaxed border-t border-white/5 space-y-4">
                    ...
                    <div className="pt-2 flex justify-end">
                      ...
                      >
                        ...
                        <span>Consultar en la Terminal Interactiva →</span>
                      </button>
                    </div>
                  </div>
                )}
        ...
        {/* Right Column: Cyber Terminal Studio with Sofia & Ivan */}
        <div className="lg:col-span-5 sticky top-24">
          <div className="rounded-[32px] bg-[#05060A] border border-white/20 shadow-[0_25px_70px_rgba(0,0,0,0.95)] p-4 sm:p-5 text-left flex flex-col h-[650px] justify-between relative overflow-hidden font-mono">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-gray-400 font-mono tracking-wider ml-1">
                  DUAL-CORE TERMINAL v3.6
                </span>
              </div>

              <div className="flex items-center gap-2">
                <span className="text-[9px] px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 font-mono">
                  LIVE CLI
                </span>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto py-3 space-y-3 text-xs leading-relaxed pr-1 scrollbar-thin">
            ...
            <form onSubmit={handleTerminalSubmit} className="pt-2 flex items-center gap-2">
              <div className="flex-1 flex items-center bg-black/80 border border-white/20 focus-within:border-[#00D1FF] rounded-xl px-3 py-2 text-xs">
                ...
                <input
                  ...
                  placeholder="Escribe tu duda a Sofía o Iván..."
                  className="w-full bg-transparent text-white placeholder-gray-600 focus:outline-none font-mono text-xs"
                />
              </div>
              <button
                type="submit"
                className="p-2.5 rounded-xl bg-gradient-to-r from-[#FF3858] to-[#00D1FF] text-white hover:scale-105 transition-transform cursor-pointer flex-shrink-0"
              >
