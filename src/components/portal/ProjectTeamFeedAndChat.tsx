...
export const MULTIPLATFORM_DEMOS = [
  {
    id: "demo_axana",
    badge: "Opción 1",
    title: "AXANA NEXT 360 (Salud Ocupacional & Suministros B2B)",
    category: "Salud Empresarial & Suministros Médicos",
    desc: "Plataforma empresarial de salud ocupacional, botiquines industriales NOM-005, Customer Intelligence Matrix y asistente médico IA.",
    url: "https://multicommerce-omega.vercel.app",
    idealFor: "Empresas de insumos médicos, salud ocupacional, seguridad industrial y cotizaciones B2B.",
    defaultPricing: "Implementación: $28,000 MXN + Renta: $3,800 MXN/mes",
  },
  {
    id: "demo_conectada",
    badge: "Opción 2",
    title: "Laboratorio Interactivo (Chatbot & Prototipo en Vivo)",
    category: "Interacción & Experiencia de Usuario",
    desc: "Experiencia táctil interactiva, asistente conversacional de ventas y simulación de flujos de negocio.",
    url: "https://innocentia.tech/#playground",
    idealFor: "Negocios que desean probar la velocidad de respuesta, diseño visual y experiencia de usuario.",
    defaultPricing: "Implementación: $24,000 MXN + Renta: $3,800 MXN/mes",
  },
  {
    id: "demo_safely",
    badge: "Opción 3",
    title: "Motor de Reservas & Boletos QR (Experience Safely)",
    category: "Turismo, Eventos & Alta Gama",
    desc: "Plataforma de reservas directas en vivo, control de cupos por horario, pagos en USD con Stripe y boletos QR.",
    url: "https://innocentia.tech/proyectos/experience-safely",
    idealFor: "Operadores turísticos, cenotes, catamaranes, eventos VIP y hospitalidad.",
    defaultPricing: "Implementación: $35,000 MXN + Renta: $4,800 MXN/mes",
  },
];
